...
AS
	...
	IF EXISTS (SELECT * FROM RelanceDecouvert 
		WHERE RelanceDecouvert.AbonnementId = @Id)
	BEGIN
		DELETE RelanceDecouvert FROM RelanceDecouvert
		WHERE RelanceDecouvert.AbonnementId = @Id
	END
END
GO
...
BEGIN  
	...
	BEGIN
	PRINT 'Il esxiste un abonnement utilisant ce type d''abonnement mise à jour du flag'
