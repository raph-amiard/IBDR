...
Exec dbo.delete_film 'X-Men',2011;
...
EXEC dbo.film_modifier_siteweb 'Le Hobbit', 2012, 'http://www.lehobbit.fr/'
...
Exec dbo.film_creer  
					...
					'|Singer,Bryan, ,17/09/1965,null,Diplômé en 1989 de l''USC School of Cinema-Television où il rencontre le compositeur John Ottman.|',
					'',
					'|Fantastique|Science fiction|Thriller|Action|';
